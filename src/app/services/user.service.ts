...
export class UserService {
  ...
  resetPassword(data: { correo: string, nuevaContrasena: string }): Observable<string> {
    return this.http.patch<string>(`${this.appUrl}${this.apiUrl}/reestablecer-contrasena`, data);
  }
