...
export const routes: Routes = [

    {
      ...
      {
        path:'agregarMaestro', component: AgregarMaestroComponent
      },
      {
        path: 'ObtenerMaestrosActivos', component: VerMaestrosActivosComponent
      },
      {
        path: 'ver-historico-maestros', component: HistoricoMaestrosComponent
      }
